...
CREATE TABLE `miaosha_goods`  (
  ...
  `start_date` datetime NULL DEFAULT NULL COMMENT '秒杀开始的时间',
...
-- ----------------------------
INSERT INTO `miaosha_goods` VALUES (1, 1, 0.01, 7, '2018-05-06 19:21:10', '2018-07-22 20:13:17');
...
-- ----------------------------
INSERT INTO `miaosha_order` VALUES (1, 13577601243, 1, 1);
INSERT INTO `miaosha_order` VALUES (2, 13577601243, 2, 2);
INSERT INTO `miaosha_order` VALUES (3, 13577601243, 3, 1);
INSERT INTO `miaosha_order` VALUES (4, 13577601243, 4, 1);
INSERT INTO `miaosha_order` VALUES (5, 13577601243, 5, 2);
...
-- ----------------------------
INSERT INTO `order_info` VALUES (1, 13577601243, 1, NULL, 'iphoneX', 1, 0.01, 1, 0, '2018-05-01 19:30:33', NULL);
INSERT INTO `order_info` VALUES (2, 13577601243, 2, NULL, '华为mate9', 1, 0.01, 1, 0, '2018-05-06 17:30:31', NULL);
INSERT INTO `order_info` VALUES (3, 13577601243, 1, NULL, 'iphoneX', 1, 0.01, 1, 0, '2018-05-06 20:53:36', NULL);
INSERT INTO `order_info` VALUES (4, 13577601243, 1, NULL, 'iphoneX', 1, 0.01, 1, 0, '2018-05-08 08:52:34', NULL);
INSERT INTO `order_info` VALUES (5, 13577601243, 2, NULL, '华为mate9', 1, 0.01, 1, 0, '2018-05-08 09:59:44', NULL);
...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13577601244 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (13577601243, 'allen', 'xcallen', '55d2c90932ec170a830910b15d5f907f', '1a2b3d4c', NULL, '2018-02-26 20:39:35', '2018-04-11 20:38:57', 1);
